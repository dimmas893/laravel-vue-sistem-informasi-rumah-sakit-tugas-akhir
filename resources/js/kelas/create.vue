...
<div class="container-header">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Form Daftar Pasien &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <router-link to="tabledokter" type="submit" class="badge badge-primary">Kembali</router-link></div>
                    <div class="card-body">
                          <div>
...
export default {
    ...
    methods: {
        ...
        async store() {
            this.loading = true;
         try {
            let response = await axios.post("/api/kelas/createkelas", this.form)
