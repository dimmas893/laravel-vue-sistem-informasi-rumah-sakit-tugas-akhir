...
<div class="container-header">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Form Edit Data Kelas &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <router-link to="tablekelas" type="submit" class="badge badge-primary">Kembali</router-link></div>
                    <div class="card-body">
                          <div>
...
export default {
    ...
    methods: {
        ...
        async getkelass() {
            let response = await axios.get('/api/kelas/' + this.$route.params.kelas);
            ...
            this.loading = true;
         try {
                let response = await axios.patch('/api/kelas/' + this.$route.params.kelas, this.form);
