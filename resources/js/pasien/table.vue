                      ...
                      <tbody>
                        <tr v-for="(pasien, index) in filteredpasiens" :key="pasien.id">
                            ...
                            <td>
                               ...
                               <router-link data-toggle="modal" data-target="#staticBackdrop" :to="{ name: 'showpasien', params: { pasien: pasien.nama } }"  type="submit" class="badge badge-info"><i class="fas fa-search"></i></router-link> 
